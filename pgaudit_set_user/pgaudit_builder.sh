...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit_set_user/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit_set_user/control.in
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit_set_user/copyright
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit_set_user/rules
    cd ../ 
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit_set_user/percona-pgaudit14_set_user.spec
    cd ${WORKDIR}
    #

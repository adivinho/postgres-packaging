...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit/control.in
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit/all.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit/rules
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgaudit/pgaudit.spec
    cd ${WORKDIR}
    #

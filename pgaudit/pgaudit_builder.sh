...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgaudit/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgaudit/control.in
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgaudit/all.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgaudit/rules
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgaudit/pgaudit.spec
    cd ${WORKDIR}
    #

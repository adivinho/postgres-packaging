...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pg_repack/Makefile.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pg_repack/rules
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pg_repack/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pg_repack/control.in
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pg_repack/pg_repack.spec
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pg_repack/pg_repack-pg15-makefile-pgxs.patch
    cd ../
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pg_repack/make.patch
    patch -p0 < make.patch
    rm -f make.patch
    cd ${WORKDIR}
    #

...
get_sources(){
    ...
    cd debian
        ...
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-15-postgis-3-scripts.install
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-15-postgis-3-scripts.lintian-overrides
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-15-postgis-3-scripts.postinst
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-15-postgis-3-scripts.prerm
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-15-postgis-3.install
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-15-postgis-3.lintian-overrides
...
build_srpm(){
    ...
    cd rpmbuild/SOURCES
    wget --no-check-certificate https://download.osgeo.org/postgis/docs/postgis-3.3.2.pdf

...
get_sources(){
    ...
    rm -f control rules
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/rules
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/preinst
    echo 9 > compat
    cd ../
    rm -rf deb_packaging
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/percona-pgbouncer.spec
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/pgbouncer-ini.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/pgbouncer.logrotate
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/pgbouncer-mkauth-py3.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/pgbouncer.service
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/pgbouncer.service.rhel7
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/pgbouncer.sysconfig
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/pgbouncer/pgbouncer.init
    cd ${WORKDIR}
    #

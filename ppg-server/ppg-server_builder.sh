...
get_sources(){
    ...
    mkdir debian
    cd debian/
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/ppg-server/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/ppg-server/rules
    echo 9 > compat
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/ppg-server/ppg-server.spec
    cd ${WORKDIR}
    #

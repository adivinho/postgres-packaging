...
get_sources(){
    ...
    mkdir debian
    cd debian/
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbadger/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbadger/rules
    chmod +x rules
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbadger/copyright
    echo 9 > compat
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbadger/percona-pgbadger.spec
    cd ${WORKDIR}
    #

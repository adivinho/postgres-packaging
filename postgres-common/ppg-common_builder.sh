...
get_sources(){
	...
	rm -rf rules control supported-versions 
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/postgres-common/control
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/postgres-common/maintscripts-functions.patch
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/postgres-common/percona-postgresql-common.templates.patch
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/postgres-common/rules
	wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/postgres-common/supported-versions
    ...
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/postgres-common/pgcommon.sh
    cd rpm
        for file in $(ls | grep postgresql); do
            mv $file "percona-$file"
        done
	rm -rf percona-postgresql-common.spec
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/postgres-common/percona-postgresql-common.spec
    cd ../
    cd ${WORKDIR}
    #

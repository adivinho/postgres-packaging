...
get_sources(){
    ...
    rm -f control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbackrest/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbackrest/compat
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbackrest/rules.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/15.3/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #

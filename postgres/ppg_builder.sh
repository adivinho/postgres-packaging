...
get_sources(){
	...
	rm -f rules control
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/postgres/rules
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/postgres/control
    ...
    cd rpm
        ...
        wget  https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/14.8/postgres/percona-postgresql-14.spec
    cd ../
    cd ${WORKDIR}
    #
